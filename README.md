...
#  未來展望
從這次鐵達尼號機器學習模型製作的過程中，我發現機器學習能夠還原事件發生的原因或是幫助人類判斷事情，未來需要人類判斷的地方都可以應用這個技術像是災難的發生我們藉由機器學習還原當時情況並判斷發生的原因，這樣就不會再發生同樣的悲劇。抑或是保險業可以透過機器學習來判斷這個客戶是否有較高的機率會使用到保險，這些都是機器學習未來能夠應用的方向 
